...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ac!=null){
            ac.setTitle(getIntent().getStringExtra("EditText"));
...
//                startActivity(new Intent(SelfActivity.this, MainActivity.class));
                //跳转网页教程
                startActivity(new Intent(EditActivity.this,HrefWebView.class).putExtra("url",
                        "https://blog.csdn.net/mxcsdn/" +
                                ...
                                "m_term=framelayout布局&spm=1018.2226.3001.4187").putExtra("title","输入框EditText"));
